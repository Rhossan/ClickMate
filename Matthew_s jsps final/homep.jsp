					...
					<div class="RecentPosts">
						<div id="prePost">
							...
							<c:forEach var="row" items="${postdata.rows}">
								...
								<span><a href="likePost.jsp?postID=${row.PostID }">   like   </a>
								<c:out value="${like.rows[0].total}" /><a href="editPostPage.jsp?postID=${row.PostID }">   edit   </a> <a href="deletePost.jsp?postID=${row.PostID}">delete</a></span>
