...
<body>
	<sql:query var="rs" dataSource="jdbc/localhost">
		select * from userdata where UserID=1001;
	</sql:query>
	<sql:query var="po" dataSource="jdbc/localhost">
		select * from postdata where OwnerID=1001 and PageID=8 order by DateTimeCreated desc;
	</sql:query>
	<div class="container">
		<!-- Search Navbar - START -->
		...
		<div class="container-fluid text-center">
			<div class="row content">
				<div class="col-sm-8 text-left">
					...
					<button type="submit" class="btn btn-success" onclick="makePost()">post</button>
					<hr>
					<h4>Recent Posts:</h4>
						...
						<div id="prePost">
							...
							<c:forEach var="row" items="${po.rows}">
								<sql:query var="like" dataSource="jdbc/localhost">
									select count(*) as total from likepost where postID=${row.PostID};
								</sql:query>
								<p></p>
								<h5>
